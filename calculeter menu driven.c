...
main(){
	int num,n=20;
	while(1){
		cout<<"Enter the number between 1 to 50 : ";
		cin>>num;
		if (num==n){
			cout<<"you win";
			break;
		}
		else if(num>n && num <=50){
			cout<<"\nentered number is lesser than the lucky number\n";
		}
		else if(num<n){
			cout<<"\nentered number is greater than the lucky number\n";
		}
		else{
			cout<<"invalid";
			break;
